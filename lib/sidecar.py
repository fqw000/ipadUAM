...
class SidecarTask(object):
    task_status_path = "/Users/wangqifei/Documents/ipadUAM/sidecar/num"
    connect_flag_path = "/Users/wangqifei/Documents/ipadUAM/sidecar/connect_flag"

    @classmethod
    def run_sidecar(cls, action="health_check"):
        system.run_cmd(f"sh /Users/wangqifei/Documents/ipadUAM/sidecar/run.sh {action}")
